...
print("Min: %s, Max: %s" % (min(newHills), max(newHills)))

# for i in range(N):
#     print("Changing i:", i, "from", newHills[i])
#     if newHills[i] > max(newHills):
#         newHills[i] = max(newHills)
#         print("New value:", newHills[i])
#     elif newHills[i] < min(newHills):
#         newHills[i] = min(newHills)
#         print("New value:", newHills[i])
#     else:
#         print("No change")
...
print(newHills)
for i in range(N):
    print((newHills[i]-originalHills[i])**2, end=" + ")
